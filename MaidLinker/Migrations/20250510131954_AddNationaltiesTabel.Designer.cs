...
namespace MaidLinker.Migrations
{
    ...
    [Migration("20250510131954_AddNationaltiesTabel")]
    partial class AddNationaltiesTabel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LangaugeMaid", b =>
                {
            ...
            modelBuilder.Entity("MaidLinker.Data.Entites.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MaidLinker.Data.Entites.Langauge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LangaugeMaid", b =>
                {
                    b.HasOne("MaidLinker.Data.Entites.Langauge", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MaidLinker.Data.Entites.UserProfile", b =>
                {
                    b.HasOne("MaidLinker.Data.Entites.City", "City")
                        .WithMany()
