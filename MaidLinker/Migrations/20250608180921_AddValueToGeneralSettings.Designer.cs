...
namespace MaidLinker.Migrations
{
    ...
    [Migration("20250608180921_AddValueToGeneralSettings")]
    partial class AddValueToGeneralSettings
    {
            ...
            modelBuilder.Entity("MaidLinker.Data.Entites.Request", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "ServedByUser")
                        .WithMany()
                        .HasForeignKey("ServedByUserId");
